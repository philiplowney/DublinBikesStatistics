...
import systemTest.tools.steps.DashboardScreenSteps;
import systemTest.tools.steps.NetworkConfigurationSteps;
import systemTest.tools.steps.PollingSteps;
import systemTest.tools.steps.RealTimeTableScreenSteps;
...
public class RealTimeStories extends JUnitStories
{
	...
	{
		return new InstanceStepsFactory(configuration(), new DashboardScreenSteps(), new NetworkConfigurationSteps(), new CommonSteps(), new RealTimeTableScreenSteps(), new PollingSteps());
	}

	@Override
	protected List<String> storyPaths()
	{
		return new StoryFinder().findPaths(codeLocationFromClass(this.getClass()), "**/*board.story", "**/excluded*.story");
	}
}